...
public class InterfazPorComision extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Empleado por Comision");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        tarifa = 0.5;
        EmpleadoPorComision Comision = new EmpleadoPorComision(Nombre,Apellido,NSS,Ventas,tarifa);
        Comision.setNombre(Nombre);
        Comision.setApellido(Apellido);
        Comision.setNumeroSeguroSocial(NSS);
        Comision.setTarifaComision(tarifa);
        Comision.setVentasBrutas(Ventas);
