...
public class InterfazBaseMasComision extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Empleado Base mas Comision");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        EmpleadoBaseMasComision SueldoMasComision = new EmpleadoBaseMasComision();
        SueldoMasComision.setNombre(Nombre);
        SueldoMasComision.setApellido(Apellido);
        SueldoMasComision.setNumeroSeguroSocial(NSS);
        SueldoMasComision.setVentasBrutas(Ventas);
        SueldoMasComision.setTarifaComision(tarifa);
        SueldoMasComision.setSalarioBase(Sueldo);
    ...
    private void btnVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVisualizarActionPerformed
       ...
       EmpleadoBaseMasComision SueldoMasComision = new EmpleadoBaseMasComision(Nombre,Apellido,NSS,Ventas,tarifa,Sueldo);
       String Visualizar = SueldoMasComision.toString();
